export const OUTBOUND_ALLOWED_FIELDS = {
  common: ["id", "text", "title", "role", "organization", "skills", "techStack", "goal", "scope", "reason", "request", "prompt", "task", "requiredShape", "context", "kind", "source", "sourceLabel", "sourceUrl", "citations", "url", "snippet", "retrievedAt", "activeQuestion", "weakestDimension", "latestAnswer", "priorAnswers", "confirmedEvidence", "untrustedJd", "questionKind", "targetLabel", "targetSource", "status", "fuzzyTerms", "conflicts", "probe", "restate", "distilledEvidenceDraft"],
